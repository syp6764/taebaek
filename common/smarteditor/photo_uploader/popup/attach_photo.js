    ...
    function html5Upload() {	
		...
		sUploadURL= '/common/smarteditor/photo_uploader/popup/file_uploader_html5.jsp';	//변경 URL입니다.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sUrl  : '/common/smarteditor/photo_uploader/popup/file_uploader.jsp',	//변경 URL입니다.
